...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 客户信息管理 <span class="c-gray en">&gt;</span> 客户信息列表 </nav>
<div class="page-container">
	...
	<span class="l" id="toolbar">
		...
		<a href="javascript:;" onclick="customer_add()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加客户信息</a>
		</shiro:hasPermission>
	</span>  
...
<script type="text/javascript">
	$(function(){
		...
		$('#infoTable').bootstrapTable({
			...
			columns: [
				...
				{field: 'remark',title: '客户详情'},
				{
					field: 'gender',title: '性别',align:'center',
					formatter:genderFormatter	/* 格式化性别1为男，2为女 */
				},
				{field: 'idCard',title: '客户身份证'},
				{field: 'realname',title: '业务员'},
				{field: 'baseName',title: '区间'},
				{
					field:'customerId',title:'操作',align:'center',
	...
	function operationFormatter(value,row,index){
		var html = '<shiro:hasPermission name="customer:delete">';		
		 ...
		 html += '</shiro:hasPermission><shiro:hasPermission name="customer:update">';
...
<script type="text/javascript">
function customer_del(customerId) {//删除方法
...
<script type="text/javascript">
	//'添加客户信息','admin-add.html','800','500'
	function customer_add(){
		layer_show("添加客户信息","customer/edit.do");
	}
	/*修改-编辑*/
	function customer_edit(customerId){
		layer_show("修改客户信息","customer/edit.do?customerId="+customerId);
	}
